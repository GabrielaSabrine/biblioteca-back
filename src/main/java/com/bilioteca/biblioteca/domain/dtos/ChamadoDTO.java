package com.bilioteca.biblioteca.domain.dtos;
...
public class ChamadoDTO implements Serializable {
	...
	@NotNull(message = "O campo Leitoré requerido")
	...
	public ChamadoDTO(Chamado obj) {
		...
		this.leitor= obj.getLeitor().getId();
		this.nomeLeitor= obj.getLeitor().getNome();
		this.nomeLivros = obj.getLivros().getNome();
	}
	...
	public void setNomeLivros(String nomeLivros) {
